...
def main():
    ...
    while window.running:
        ...
        #     # per_line_color=Colors,
        # )
        centers = ti.Vector.field(2, dtype=ti.f32, shape=1)
        centers[0]=ti.Vector([0.5, 0.5])
        # canvas.circles(centers, radius=0.45, color=ti.Vector([0.0, 0.0, 1.0]))
        canvas.circles(centers, radius=0.45, color=(1.,0.,0.))
        canvas.circles(centers, radius=0.43, color=(0.,0.,0.))
